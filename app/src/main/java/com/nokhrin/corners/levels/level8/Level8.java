...
public class Level8 {
    public void startLevel(ActivityLevels activity) {
        ...
        checkersPositions[3][2] = STONE_CHECKER;
        checkersPositions[3][4] = STONE_CHECKER;
        checkersPositions[4][1] = STONE_CHECKER;
        checkersPositions[4][3] = STONE_CHECKER;
        checkersPositions[4][5] = STONE_CHECKER;
        checkersPositions[5][2] = STONE_CHECKER;
        checkersPositions[5][4] = STONE_CHECKER;
        //for target points
