...
public class Level9 {
    public  void startLevel(ActivityLevels activity) {
        ...
        int countToMove = 15; //count of move player can
        int countPointInLevel = 6; //count target point
        ...
        checkersPositions[6][3] = WOODMAN_CHECKER;
        //for target points
        ...
        marksPositions[3][6] = TARGET_POINT_FOR_WHITE_CHECKER;
